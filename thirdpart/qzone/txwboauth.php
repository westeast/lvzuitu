...
$ip = "Unknown"; 
   ...
   return $ip;
	...
	function pub_abc($openid=""){
		//$param['format']=$format;
		$param['openid']=$openid;
		return $this->oauth->get('http://openapi.qzone.qq.com/user/get_user_info',$param); 
...
class WeiboOAuth { 
     ...
     * @ignore 
     */ 
    public $host = "http://openapi.qzone.qq.com/"; 
    /** 
     * Set timeout default. 
     * 
     * @ignore 
     ...
     * @ignore 
     */ 
    function accessTokenURL()  { return 'http://openapi.qzone.qq.com/oauth/qzoneoauth_access_token'; } 
    /** 
     * @ignore 
     */ 
    ...
    */ 
   function requestTokenURL() { return 'http://openapi.qzone.qq.com/oauth/qzoneoauth_request_token'; } 
     ...
     * @return string 
     */ 
    function getAuthorizeURL($token, $sign_in_with_Weibo = TRUE , $qqzonekey,$url) { 
        if (is_array($token)) { 
            $token = $token['oauth_token']; 
        } 
        if (empty($sign_in_with_Weibo)) { 
            return $this->authorizeURL() ."?oauth_consumer_key={$qqzonekey}"."&oauth_token={$token}"."&oauth_callback={$url}"; 
        } else { 
            return $this->authenticateURL() . "?oauth_consumer_key={$qqzonekey}"."&oauth_token={$token}"."&oauth_callback={$url}";
        } 
    } 
